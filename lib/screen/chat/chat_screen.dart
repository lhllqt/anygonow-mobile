...
import 'package:untitled/pb/const.pbenum.dart';
import 'package:untitled/screen/brand_detail/brand_detail.dart';
import 'package:untitled/screen/chat/completed_customer_chat_screen.dart';
import 'package:untitled/screen/chat/completed_handyman_chat_screen.dart';
import 'package:untitled/screen/chat/connected_customer_chat_screen.dart';
import 'package:untitled/screen/chat/connected_handyman_chat_screen.dart';
...
class ChatScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (globalController.user.value.role != ROLE.HANDYMAN.value &&
        !messageController.completedChat) {
      return ConnectedCustomerChatScreen();
    }
    if (globalController.user.value.role == ROLE.HANDYMAN.value &&
        !messageController.completedChat) {
      return ConnectedHandymanChatScreen();
    }
    if (globalController.user.value.role != ROLE.HANDYMAN.value &&
        messageController.completedChat) {
      return CompletedCustomerChatScreen();
    }
    if (globalController.user.value.role == ROLE.HANDYMAN.value &&
        messageController.completedChat) {
      return CompletedHandymanChatScreen();
    }
    return Container();
